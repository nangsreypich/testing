...
if(isset($_POST["do"]) && ($_POST["do"] == "add_attendance1")){
    ...
    if($user_type == "Student"){
        header("Location: view/add_attendance1.php?do=alert_from_insert_student_atd&msg=$msg&monthly_fee=$monthly_fee&index=$index_number");
    } elseif($user_type == "Teacher"){
        header("Location: view/add_attendance1.php?do=alert_from_insert_teacher_atd&msg=$msg");
    } elseif($user_type == "Staff"){
        header("Location: view/add_attendance1.php?do=alert_from_insert_staff_atd&msg=$msg");
    } else {
        header("Location: view/add_attendance1.php?do=wrong_index&msg=$msg");
    }
}
?>
