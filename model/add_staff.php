...
if(isset($_POST["do"]) && ($_POST["do"] == "add_staff")){
    ...
    $sql1="SELECT * FROM staff where index_number='$index_number'";    
    ...
    if($index_number == $index_number1 ){
        ...
        $sql = "INSERT INTO staff (index_number, full_name, kh_name, gender, address, phone, dob, pob, email, reg_date, position, join_year, join_date)
    ...
    header("Location: view/staff.php?do=alert_from_insert&msg=$msg"); 
}
?>
