...
if (isset($_POST["do"]) && ($_POST["do"] == "update_admin_profile")) {
	...
	if (!$name) {
		...
		$sql = "update admin set full_name='" . $full_name . "',kh_name='" . $kh_name . "', gender='" . $gender . "',address='" . $address . "', phone='" . $phone . "',email='" . $email . "' where id='$id'";
	...
	header("Location: view/admin_profile.php?do=alert_from_update&msg=$msg");
	exit;
}
