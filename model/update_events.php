...
if(isset($_POST["do"])&&($_POST["do"]=="update_events")){
	...
	if($date_time_range == $date_time_range2){
		$sql1 = "update events set title='".$title."',note='".$note."',color='".$color."',category_id='".$category_id."', google_link='".$google_link."', grade_id='".$grade_id."' where id='$id'";
		...
		$sql1 = "update events set title='".$title."',note='".$note."',color='".$color."',category_id='".$category_id."', google_link='".$google_link."', grade_id='".$grade_id."',start_date_time='".$start_date_time1."',end_date_time='".$end_date_time1."' where id='$id'";
