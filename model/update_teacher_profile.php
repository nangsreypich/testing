...
if (isset($_POST["do"]) && ($_POST["do"] == "update_teacher_profile")) {
	...
	if (!$name) {
		...
		$sql = "update teacher set full_name='" . $full_name . "',kh_name='" . $kh_name . "', gender='" . $gender . "',address='" . $address . "', phone='" . $phone . "',email='" . $email . "' where id='$id'";
	...
	header("Location: view/teacher_profile2.php?do=alert_from_update&msg=$msg");
	exit;
}
