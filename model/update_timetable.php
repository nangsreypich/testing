...
if(isset($_POST["do"])&&($_POST["do"]=="update_timetable")){
	...
	$sql1="SELECT * FROM timetable WHERE day='$day' and start_time=$start_time";
	...
	if($id == $id1){//MSK-000143-U-1
		if($end_time == $end_time1){//MSK-000143-U-2
			if($grade_id != $subject_id1 || $teacher_id != $teacher_id1 ){//MSK-000143-U-3
				$sql="update timetable set grade_id='".$grade_id."', teacher_id='".$teacher_id."' where id='$id'";
			...
			$sql2="SELECT * FROM timetable WHERE day='$day'  and end_time > $start_time and (start_time <= $start_time or start_time<$end_time) and id!=$id";
		$result2=mysqli_query($conn,$sql2);
			...
			if(mysqli_num_rows($result2) > 0){
				...
				//MSK-000143-U-9
				$sql="update timetable set grade_id='".$grade_id."',teacher_id='".$teacher_id."',end_time='".$end_time."' where id='$id'";
		...
		if(mysqli_num_rows($result2) > 0){
			...
			//MSK-000143-U-14
			$sql="update timetable set day='".$day."', grade_id='".$grade_id."',teacher_id='".$teacher_id."',start_time='".$start_time."',end_time='".$end_time."' where id='$id'";
